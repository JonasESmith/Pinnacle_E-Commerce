...
namespace Nop.Services.Orders
{
  ...
  public partial class OrderProcessingService : IOrderProcessingService
  {
    ...
    // @JONAS - Order placed I can change this so that if the customer attribute is equal to a certain thing I can eamil their sales representative. 
    /// <summary>
    ...
    public virtual PlaceOrderResult PlaceOrder(ProcessPaymentRequest processPaymentRequest)
    {
      ...
      try
      {
        ...
        if (processPaymentResult.Success)
        {
          ...
          // May need to go through and create a new property for the customer so I can better represent important models here. 
          // Customer tempCustomer = details.Customer;
          // int customerQuerryId = details.Customer.Id;





          // @JONAS - ORDER placed I could also edit this section to determine the sale rep. 
          //notifications
