...
namespace Nop.Data.Mapping.Customers
{
    ...
    {
        #region Methods
        // @JONAS - Add property for salesRep
        /// <summary>
        ...
        public override void Configure(EntityTypeBuilder<Customer> builder)
        {
            ...
            // @JONAS - Removing this for now, I think if I can use the custom attributes I will be better set. 
            //builder.Property(customer => customer.SalesRep).HasMaxLength(255);
