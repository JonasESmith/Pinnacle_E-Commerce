...
namespace Nop.Web.Infrastructure
{
    ...
    public partial class RouteProvider : IRouteProvider
    {
        ...
        public void RegisterRoutes(IRouteBuilder routeBuilder)
        {
            ...
            // @JONAS adding the new whole-sale catalog page
            routeBuilder.MapLocalizedRoute("WholeSaleCatalog", "wholeSaleCatalog",
				new { controller = "Common", action = "WholeSaleCatalog" });
            
      
            // @JONAS adding the newer links to the education page
            routeBuilder.MapLocalizedRoute("Education", "education",
				new { controller = "Common", action = "Education" });
            ...
            routeBuilder.MapLocalizedRoute("AddAllProductToCart-Details", "addproducttocart/details/{productId:min(0)}/{shoppingCartTypeId:min(0)}",
				new { controller = "ShoppingCart", action = "AddAllProductToCart_Details" });
