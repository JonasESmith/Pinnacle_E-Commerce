...
namespace Nop.Web.Controllers
{
  ...
  public partial class CheckoutController : BasePublicController
  {
    ...
    //@JONAS Email retreival can happen here
    ...
    public virtual IActionResult ConfirmOrder()
    {
      ...
      try
      {
        ...
        Customer tempCustomer = _workContext.CurrentCustomer;


        /// @JONAS PlaceOrder Here
        /// string selectedCustomerAttributes = tempCustomer.GetAttribute<string>(SystemCustomerAttributeNames.CustomCustomerAttributes, _genericAttributeService);


        //IList<CustomerAttribute> customerAttributes = customerAttributeService.GetAllCustomerAttributes();
